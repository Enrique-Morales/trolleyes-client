...
moduleFactura.controller('lineaController', ['$scope', '$http', '$location', 'toolService',
...
$scope.viewReg = function (id) {
            ...
            $http({
                ...
                url: `http://localhost:8081/trolleyes/json?ob=linea&op=get&id=${id}`
        ...
        function loadTable(numRegistros, page) {
            $http({
                method: 'GET',
                withCredentials: true,
                url: `http://localhost:8081/trolleyes/json?ob=linea&op=getpage&rpp=${numRegistros}&page=${page}`
            }).then(function (response) {
